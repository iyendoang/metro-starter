        <div class="modal fade" id="kt_modal_district" tabindex="-1" aria-hidden="true" data-bs-focus="false">
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content rounded">
                    <form class="form" action="#" id="kt_modal_district_form">
                        <input type="hidden" name="action" id="district_action" />
                        <input type="hidden" name="id_old" id="id_id_old" />
                        <div class="modal-header" id="kt_modal_district_header">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                <label class="required fs-5 fw-bold mb-2">ID Kecamatan</label>
                                <input class="form-control form-control-solid" placeholder="ID Kecamatan" name="id" id="district_id" />
                            </div>
                            <div class="d-flex flex-column mb-5 fv-row">
                                <label class="required fs-5 fw-bold mb-2">Nama Kecamatan</label>
                                <input class="form-control form-control-solid" placeholder="Nama Kecamatan" name="district_name" id="district_district_name" />
                            </div>
                            <div class="fv-row mb-5">
                                <div class="d-flex flex-stack">
                                    <div class="me-5">
                                        <label class="fs-5 fw-bold">Status Kecamatan?</label>
                                        <div class="fs-7 fw-bold text-muted">Status aktif akan tampil pada opsi provinsi</div>
                                    </div>
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" name="district_status" type="checkbox" value="1" checked="checked" />
        ...
        <script src="districts/wilayah_scripts.js"></script>