    ...
    <div class="card mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" data-kt-kota-modal-form="add_row_district" data-target="#kt_modal_district">New Kota</a>
                    </div>
        ...
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_districts_table">
                    <thead>
...
<script src="districts/districts_script.js"></script>
<?php include 'districts/districts_form.php'; ?>