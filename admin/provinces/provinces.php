    ...
    <div class="card mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Daftar Provinsi</span>
            ...
            <div class="card-toolbar">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" data-kt-provinsi-modal-form="add_row_province" data-target="#kt_modal_province">New Provinsi</a>
                    </div>
        ...
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_provinces_table">
                    <thead>
...
<script src="provinces/provinces_script.js"></script>
<?php include 'provinces/provinces_form.php'; ?>